...
<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			$("#idPreviewButton").click(function(){
				$("#newSlideForm").attr("action", "doPreviewSlide");
			...
			$("#idSaveButton").click(function(){
				if (!$("#slide_name").val()) {
					...
					$("#content").val(myVal);	
					$("#newSlideForm").attr("action", "doSaveSlide");
					$("#newSlideForm").submit();
				}
			});
			...
			<div class="row">
				...
				<div class="col-sm-3" style="margin-top: 20px; margin-bottom: 10px;">
					<form role="form" id="newSlideForm" method="post">
						<input type="hidden" id="idSlide" name="idSlide" /> <input type="hidden" id="content" name="content" />
						<div class="form-inline">
							<label for="slidename">Name&nbsp;&nbsp;</label> <input class="form-control" id="slide_name" name="slide_name"
								placeholder="Enter slide name" onchange="fCheckEmpty(this);">
						</div>
					</form>
				</div>
