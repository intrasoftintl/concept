			...
			<ul class="nav navbar-nav">
				<li id="storyboard" class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
					...
					<ul class="dropdown-menu" role="menu">
						<li><a href="${pageContext.request.contextPath}/moodboard/new?pid=<%=request.getParameter("pid")%>&uid=<%=request.getParameter("uid")%>"><fmt:message key="bar.new_slide"/></a></li>
						<li><a href="${pageContext.request.contextPath}/moodboard/view?pid=<%=request.getParameter("pid")%>&uid=<%=request.getParameter("uid")%>"><fmt:message key="bar.slides"/></a></li>
