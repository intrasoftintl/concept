...
public class MindmapServiceImpl implements MindmapService {
	...
	public void removeCollaboration(@NotNull Mindmap mindmap, @NotNull Collaboration collaboration) throws CollaborationException {
		...
		// When you delete an object from hibernate you have to delete it from
		// *all* collections it exists in...
	...
	public void addCollaboration(@NotNull Mindmap mindmap, @NotNull String email, @NotNull CollaborationRole role, @Nullable String message)
		...
		if (collaboration == null) {
			...
			// If the relationship already exists and the role changed then only
			// update the role
	...
	@Override
	public void revertChange(@NotNull Mindmap mindmap, int historyId) throws WiseMappingException, IOException {
	...
	public List<Projects> getAllProjects() {
		return mindmapManager.getAllProjects();
	}
	
	public Projects findProjectById(int idProject) {
		return mindmapManager.getProjectById(idProject);
	}
