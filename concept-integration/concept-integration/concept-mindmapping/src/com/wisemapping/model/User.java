...
public class User extends Collaborator implements Serializable {
	...
	public static final User generateConceptUser() {
		User user = new User();
		user.setId(2); 
		user.firstname = "Concept";
		user.lastname = "User";
		user.password = "admin";
		user.activationCode = 1237;
		user.activationDate = GregorianCalendar.getInstance();
		user.setEmail("admin@wisemapping.org");
		user.setLocale("EN");
		/*
		private String firstname;
		private String lastname;
	...
	public static final User generateTestUser() {
		User user = new User();
		user.setId(1); 
		user.firstname = "Test";
		user.lastname = "User";
		...
		user.activationCode = 1237;
		user.activationDate = GregorianCalendar.getInstance();
		user.setEmail("test@wisemapping.org");
		user.setLocale("EN");
		/*
		private String firstname;
		private String lastname;
