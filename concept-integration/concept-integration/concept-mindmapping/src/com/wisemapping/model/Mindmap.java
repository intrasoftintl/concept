...
public class Mindmap {
	...
	private int idUserConcept;
	private int idProjectConcept;
	...
	public int getIdUserConcept() {
		return idUserConcept;
	}

	public void setIdUserConcept(int idUserConcept) {
		this.idUserConcept = idUserConcept;
	}

	public int getIdProjectConcept() {
		return idProjectConcept;
	}

	public void setIdProjectConcept(int idProjectConcept) {
		this.idProjectConcept = idProjectConcept;
	}
