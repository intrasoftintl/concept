        ...
        $(function () {
            $('#mindmapListTable').dataTable({
                ...
                aoColumns: [
                    ...
                    {
                        sTitle: "<spring:message code="PROJECT"/>",
	...
	<div class="container">
		<div class="row hide" id="messagesPanel" style="margin-top: 20px">
			<div class="alert alert-danger alert-block fade in col-md-8 col-md-offset-2">
				<strong>[<spring:message code="UNEXPECTED_ERROR" />]
				</strong>
				<p>
					<spring:message code="UNEXPECTED_ERROR_SERVER_ERROR" />
				</p>
				<div></div>
			</div>
		</div>
		...
		<div class="row">
			<div class="col-md-2" id="foldersContainer">
				<ul class="nav nav-pills nav-stacked filterList">
					<li data-filter="all" class="active" style="display: none"><a href="#"><i class="glyphicon glyphicon-inbox glyphicon-white"></i>
							<spring:message code="ALL_MAPS" /> </a></li>
			...
			<div class="buttonsToolbar btn-toolbar ${requestScope['google.ads.enabled']?'col-md-9':'col-md-10'}">
				<div id="tableActions">
					...
					<div class="btn-group" id="pageButtons">
						<button class="btn btn-sm" id="pPageBtn">
							<strong>&lt;</strong>
						</button>
						<button class="btn btn-sm" id="nPageBtn">
							<strong>&gt;</strong>
						</button>
					</div>
				</div>
				...
				<div class="btn-group">
					...
					<ul id="labelList" class="dropdown-menu">
						<li id="createLabelBtn"><a href="#" onclick="return false"> <i class="glyphicon glyphicon-plus"></i> <spring:message
									code="CREATE" />
						</a></li>
					</ul>
				</div>
				...
				<div id="infoBtn" class="btn-group act-single" style="display: none">
					<button class="btn btn-sm btn-primary">
						<i class="glyphicon glyphicon-exclamation-sign glyphicon-white"></i>
				...
				<div id="actionsBtn" class="btn-group act-single" style="display: none">
					<button class="btn btn-sm btn-primary dropdown-toggle" data-toggle="dropdown">
						<i class="glyphicon glyphicon-asterisk glyphicon-white"></i>
						<spring:message code="MORE" />
						<span class="caret"></span>
					</button>

					<ul class="dropdown-menu">
						<li id="duplicateBtn"><a href="#" onclick="return false"><i class="glyphicon glyphicon-plus-sign"></i> <spring:message
									code="DUPLICATE" /></a></li>
						<li id="renameBtn"><a href="#" onclick="return false"><i class="glyphicon glyphicon-edit"></i> <spring:message code="RENAME" /></a></li>
						<li id="publishBtn"><a href="#" onclick="return false"><i class="glyphicon glyphicon-globe"></i> <spring:message
									code="PUBLISH" /></a></li>
						<li id="shareBtn"><a href="#" onclick="return false"><i class="glyphicon glyphicon-share"></i> <spring:message code="SHARE" /></a></li>
						<li id="exportBtn"><a href="#" onclick="return false"><i class="glyphicon glyphicon-download"></i> <spring:message
									code="EXPORT" /></a></li>
						<li id="printBtn"><a href="#" onclick="return false"><i class="glyphicon glyphicon-print"></i> <spring:message code="PRINT" /></a></li>
			...
			<div class="col-md-1" style="padding-top: 25px">
				<c:if test="${requestScope['google.ads.enabled']}">
					...
					<ins class="adsbygoogle" style="display: inline-block; width: 120px; height: 600px" data-ad-client="ca-pub-7564778578019285"
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						...
						<h3>
							<spring:message code="NEW_MAP_MSG" />
						</h3>
					</div>
					<div class="modal-body">
						...
						<form class="form-horizontal">
							<fieldset>
								...
								<div class="form-group">
									<label class="col-md-3 control-label" for="newDec"><spring:message code="PROJECT"/>:</label>
									<div class="col-md-8">
										<select class="form-control" name="idProject" id="sel1">
											<c:forEach items="${projects}" var="myProject">
												<option value="${myProject.id}">${myProject.title}</option>
											</c:forEach>
										</select>
									</div>
								</div>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button class="close" data-dismiss="modal">x</button>
						<h3>
							<spring:message code="NEW_LABEL_MSG" />
						</h3>
					</div>
					<div class="modal-body">
						<div class="errorMessage"></div>
						<form class="form-horizontal">
							<fieldset>
								...
								<div id="colorGroup" class="form-group">
									...
									<div class="col-md-1">
										<input class="form-control" name="color" id="colorChooser" style="display: none" required="required" value="#000000" /> <span
											class="input-group-addon colorInput"><i></i></span>
									</div>
								</div>
								<div id="iconGroup" class="form-group">
									<label class="col-md-3 control-label" for="iconChooser"><spring:message code="ICON" />:</label> <input class="form-control"
										name="iconName" id="iconChooser" style="display: none" required="required" value="glyphicon glyphicon-tag" />
									<div class="col-md-1">
						...
						<form class="form-horizontal">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-8">
										<input name="title" id="title" type="text" required="required" placeholder="<spring:message code="MAP_DESCRIPTION_HINT"/>"
											autofocus="autofocus" class="form-control" maxlength="255" />
									</div>
								</div>
								<div class="form-group">
									<label for="description" class="col-md-3 control-label"><spring:message code="DESCRIPTION" />: </label>

									<div class="col-md-8">
										<input name="description" id="description" type="text" placeholder="<spring:message code="MAP_DESCRIPTION_HINT"/>"
						...
						<form class="form-horizontal">
							<fieldset>
								<div class="form-group">
									...
									<div class="col-md-8">
										<input name="title" id="renTitle" required="required" autofocus="autofocus" class="form-control" maxlength="255" />
									</div>
								</div>
								<div class="form-group">
									<label for="renDescription" class="col-md-3 control-label"><spring:message code="DESCRIPTION" />:</label>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<button class="close" data-dismiss="modal">x</button>
						<h3>
							<spring:message code="DELETE_MINDMAP" />
						</h3>
					</div>
					<div class="alert alert-block alert-warning">
						...
						<spring:message code="DELETE_MAPS_WARNING" />
					</div>
					<div class="modal-footer">
						<button class="btn btn-sm btn-primary btn-accept" data-loading-text="<spring:message
                            code="SAVING"/> ...">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="alert alert-block alert-warning">
						...
						<spring:message code="DELETE_LABELS_WARNING" />
					</div>
					<div class="modal-footer">
						<button class="btn btn-sm btn-primary btn-accept"
							data-loading-text="<spring:message
                                code="SAVING"/> ...">
							<spring:message code="DELETE" />
						</button>
						<button class="btn btn-cancel" data-dismiss="modal">
		...
		<div id="export-dialog-modal" class="modal fade" tabindex="-1">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body"></div>
					<div class="modal-footer">
						<button class="btn btn-sm btn-primary btn-accept" data-loading-text="Exporting...">
							<spring:message code="EXPORT" />
						</button>
						<button class="btn btn-cancel" data-dismiss="modal">
							<spring:message code="CANCEL" />
