    ...
    <script type="text/javascript">
        ...
        $(document).on('loadcomplete', function (resource) {
                ...
                options.persistenceManager = new mindplot.RESTPersistenceManager(
                        {
                            ...
                            documentUrlConcept:"c/restful/maps/{id}/{userId}/document/concept",
            ...
            <c:if test="${memoryPersistence || readOnlyMode}">
                ...
                var mindmap = mindmap = persistence.load(mapId, userId);
...
<div id="header">
    <div id="headerInfo">
        ...
        <div id="headerMapTitle"><spring:message code="NAME"/>: <span id="mindmapTitle"><c:out value="${mindmap.title}"/></span></div>
    </div>
