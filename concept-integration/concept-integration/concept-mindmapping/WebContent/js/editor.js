...
mindplot.Events = new Class({$events: {},_removeOn: function(a) {
...
Options = new Class({setOptions: function() {
...
web2d.peer = {svg: {}};
web2d.peer.utils = {};
web2d.peer.utils.EventUtils = {broadcastChangeEvent: function(elementPeer, type) {
...
web2d.peer.utils.TransformUtil = {workoutScale: function(elementPeer) {
...
web2d.peer.svg.ElementPeer = new Class({initialize: function(svgElement) {
...
web2d.peer.svg.ElipsePeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
...
web2d.peer.svg.Font = new Class({initialize: function() {
        this._size = 10;
        this._style = "normal";
        this._weight = "normal"
    },init: function(args) {
...
web2d.peer.svg.ArialFont = new Class({Extends: web2d.peer.svg.Font,initialize: function() {
        this.parent();
...
web2d.peer.svg.PolyLinePeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
...
web2d.peer.svg.CurvedLinePeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
...
web2d.peer.svg.ArrowPeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
        var svgElement = window.document.createElementNS(this.svgNamespace, "path");
        this.parent(svgElement);
        this._style = {};
...
web2d.peer.svg.TextPeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
        ...
        return {font: this._font.getFont(),size: parseInt(this._font.getSize()),style: this._font.getStyle(),weight: this._font.getWeight()}
    },setSize: function(size) {
        this._font.setSize(size);
        this._updateFontStyle()
    },getWidth: function() {
...
web2d.peer.svg.WorkspacePeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function(element) {
...
web2d.peer.svg.GroupPeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
...
web2d.peer.svg.RectPeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function(arc) {
...
web2d.peer.svg.ImagePeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
...
web2d.peer.svg.TimesFont = new Class({Extends: web2d.peer.svg.Font,initialize: function() {
        this.parent();
...
web2d.peer.svg.LinePeer = new Class({Extends: web2d.peer.svg.ElementPeer,initialize: function() {
...
web2d.peer.svg.TahomaFont = new Class({Extends: web2d.peer.svg.Font,initialize: function() {
        this.parent();
...
web2d.peer.svg.VerdanaFont = new Class({Extends: web2d.peer.svg.Font,initialize: function() {
        this.parent();
...
web2d.Element = new Class({initialize: function(peer, attributes) {
        this._peer = peer;
        if (peer == null) {
...
web2d.Elipse = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.Font = new Class({initialize: function(fontFamily, textPeer) {
...
web2d.Group = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.Image = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.Line = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.PolyLine = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.CurvedLine = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.Arrow = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.Rect = new Class({Extends: web2d.Element,initialize: function(arc, attributes) {
        if (arc && arc > 1) {
...
web2d.Text = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
web2d.peer.ToolkitSVG = {init: function() {
...
web2d.Workspace = new Class({Extends: web2d.Element,initialize: function(attributes) {
...
core.Point = new Class({initialize: function(x, y) {
        this.x = x;
        this.y = y
...
mindplot.Messages = new Class({Static: {init: function(a) {
            a = $defined(a) ? a : "en";
...
mindplot.TopicEventDispatcher = new Class({Extends: mindplot.Events,Static: {_instance: null,configure: function(a) {
        ...
        if (a.getShapeType() != mindplot.model.TopicShape.IMAGE && !this._readOnly && d == mindplot.TopicEvent.EDIT) {
            ...
            this.fireEvent(d, {model: a,readOnly: this._readOnly})
        }
    },isVisible: function() {
        return this._activeEditor != null && this._activeEditor.isVisible()
    }});
mindplot.TopicEvent = {EDIT: "editnode",CLICK: "clicknode"};
mindplot.model.IMindmap = new Class({initialize: function() {
        throw "Unsupported operation"
...
mindplot.model.Mindmap = new Class({Extends: mindplot.model.IMindmap,initialize: function(b, a) {
...
mindplot.model.INodeModel = new Class({initialize: function(a) {
...
mindplot.model.INodeModel._uuid = 0;
mindplot.model.NodeModel = new Class({Extends: mindplot.model.INodeModel,initialize: function(b, a, c) {
...
mindplot.model.RelationshipModel = new Class({Static: {_nextUUID: function() {
...
mindplot.ActionDispatcher = new Class({Implements: [mindplot.Events],initialize: function(a) {
...
mindplot.StandaloneActionDispatcher = new Class({Extends: mindplot.ActionDispatcher,initialize: function(a) {
        this.parent(a);
...
mindplot.CommandContext = new Class({initialize: function(a) {
...
mindplot.DesignerModel = new Class({Implements: [mindplot.Events],initialize: function(a) {
        this._zoom = a.zoom;
        this._topics = [];
        this._relationships = []
    },getZoom: function() {
        ...
        return a
    },showEditNameEditor: function() {
        //var c = this.getId();
        //var a = this.getModel();
        var d = {getValue: function() {
                return $('#mindmapTitle').text(); 
            },setValue: function(g) {
            	$('#mindmapTitle').text(g)
            }};
        var b = new mindplot.widget.NameEditor(d);
        //this._getTopicEventDispatcher().close(true);
        b.show()    	
    }
    });
mindplot.Designer = new Class({Extends: mindplot.Events,initialize: function(b, a) {
        ...
        var f = mindplot.NodeGraph.create(e, {readOnly: j});
        ...
        if (b.length > 0) {
            this._actionDispatcher.addFeatureToTopic(b[0], mindplot.TopicFeature.Icon.id, {id: a})
        }
    },addLink: function() {
        var b = this.getModel();
...
mindplot.ScreenManager = new Class({initialize: function(a) {
...
mindplot.Workspace = new Class({initialize: function(d, c) {
...
mindplot.ShirinkConnector = new Class({initialize: function(b) {
...
mindplot.Keyboard = new Class({initialize: function() {
...
mindplot.DesignerKeyboard = new Class({Extends: mindplot.Keyboard,Static: {register: function(a) {
...
mindplot.DesignerKeyboard.specialKeys = {8: "backspace",9: "tab",10: "return",13: "enter",16: "shift",17: "ctrl",18: "alt",19: "pause",20: "capslock",27: "esc",32: "space",33: "pageup",34: "pagedown",35: "end",36: "home",37: "left",38: "up",39: "right",40: "down",45: "insert",46: "del",96: "0",97: "1",98: "2",99: "3",100: "4",101: "5",102: "6",103: "7",104: "8",105: "9",106: "*",107: "+",109: "-",110: ".",111: "/",112: "f1",113: "f2",114: "f3",115: "f4",116: "f5",117: "f6",118: "f7",119: "f8",120: "f9",121: "f10",122: "f11",123: "f12",144: "numlock",145: "scroll",186: ";",191: "/",220: "\\",222: "'",224: "meta"};
mindplot.TopicStyle = new Class({Static: {_getStyles: function(c) {
...
mindplot.NodeGraph = new Class({initialize: function(b, a) {
        $assert(b, "model can not be null");
        this._options = a;
...
mindplot.Topic = new Class({Extends: mindplot.NodeGraph,initialize: function(b, a) {
        this.parent(b, a);
        this._children = [];
        this._parent = null;
        this._relationships = [];
                ...
                if (f == mindplot.model.TopicShape.ELLIPSE) {
                    ...
                    if (f == mindplot.model.TopicShape.ROUNDED_RECT) {
                        ...
                        if (f == mindplot.model.TopicShape.LINE) {
                            a = new web2d.Line({strokeColor: "#495879",strokeWidth: 1});
                            a.setSize = function(h, g) {
                                this.size = {width: h,height: g};
                                a.setFrom(0, g);
                                a.setTo(h, g);
        ...
        var g = {width: 100,height: 100,coordSizeWidth: 100,coordSizeHeight: 100};
        ...
        this._getTopicEventDispatcher().show(this, {text: a})
        ...
        var d = {getValue: function() {
                ...
                if (!$defined(g)) {
                    ...
                    if (e.length > 0) {
                        f.changeFeatureToTopic(c, e[0].getId(), {text: g})
                    } else {
                        f.addFeatureToTopic(c, mindplot.TopicFeature.Note.id, {text: g})
                    }
                }
            }};
        ...
        var d = {getValue: function() {
                ...
                if (!$defined(g)) {
                    ...
                    if (e.length > 0) {
                        f.changeFeatureToTopic(c, e[0].getId(), {url: g})
                    } else {
                        f.addFeatureToTopic(c, mindplot.TopicFeature.Link.id, {url: g})
                    }
                }
            }};
        this.closeEditors();
        ...
        if (a || e) {
            ...
            if (a) {
                mindplot.EventBus.instance.fireEvent(mindplot.EventBus.events.NodeResizeEvent, {node: this.getModel(),size: b})
            }
        }
        ...
        if (this.isInWorkspace()) {
            mindplot.EventBus.instance.fireEvent(mindplot.EventBus.events.NodeConnectEvent, {parentNode: b.getModel(),childNode: this.getModel()})
        }
    },append: function(b) {
...
mindplot.CentralTopic = new Class({Extends: mindplot.Topic,initialize: function(b, a) {
        this.parent(b, a)
    },_registerEvents: function() {
        this.parent();
...
mindplot.MainTopic = new Class({Extends: mindplot.Topic,initialize: function(b, a) {
        this.parent(b, a)
    },INNER_RECT_ATTRIBUTES: {stroke: "0.5 solid #009900"},_buildDragShape: function() {
...
mindplot.DragTopic = new Class({initialize: function(b, c, a) {
...
mindplot.DragManager = new Class({initialize: function(b, a) {
        this._workspace = b;
...
mindplot.DragPivot = new Class({initialize: function() {
        this._position = new core.Point();
...
mindplot.ConnectionLine = new Class({initialize: function(c, f, e) {
...
mindplot.Relationship = new Class({Extends: mindplot.ConnectionLine,Static: {getStrokeColor: function() {
            return "#9b74e6"
        },type: "Relationship"},initialize: function(e, g, d) {
...
mindplot.DragConnector = new Class({initialize: function(a, b) {
...
mindplot.TextEditor = new Class({initialize: function(a) {
        this._topic = a
...
mindplot.MultilineTextEditor = new Class({Extends: mindplot.Events,initialize: function() {
        this._topic = null;
        this._timeoutId = -1
    },_buildEditor: function() {
        var a = $("<div></div>").attr("id", "textContainer").css({display: "none",zIndex: "8",overflow: "hidden",border: "0 none"});
...
mindplot.util.Shape = {isAtRight: function(a, b) {
...
mindplot.util.FadeEffect = new Class({Extends: mindplot.Events,initialize: function(b, a) {
        this._isVisible = a;
        this._element = b
    },start: function() {
...
mindplot.persistence.ModelCodeName = {BETA: "beta",PELA: "pela",TANGO: "tango"};
mindplot.persistence.XMLSerializer_Pela = new Class({toXML: function(o) {
...
mindplot.persistence.XMLSerializer_Tango = new Class({Extends: mindplot.persistence.XMLSerializer_Pela});
mindplot.persistence.Pela2TangoMigrator = new Class({initialize: function(a) {
...
mindplot.persistence.XMLSerializer_Beta = new Class({toXML: function(b) {
        ...
        return mindplot.TopicFeature.createModel(mindplot.TopicFeature.Link.id, {url: a.getAttribute("url")})
...
mindplot.persistence.Beta2PelaMigrator = new Class({initialize: function(a) {
...
mindplot.persistence.XMLSerializerFactory._codeNames = [{codeName: mindplot.persistence.ModelCodeName.BETA,serializer: mindplot.persistence.XMLSerializer_Beta,migrator: function() {
        }}, {codeName: mindplot.persistence.ModelCodeName.PELA,serializer: mindplot.persistence.XMLSerializer_Pela,migrator: mindplot.persistence.Beta2PelaMigrator}, {codeName: mindplot.persistence.ModelCodeName.TANGO,serializer: mindplot.persistence.XMLSerializer_Tango,migrator: mindplot.persistence.Pela2TangoMigrator}];
mindplot.PersistenceManager = new Class({Static: {
	loadFromDom: function(b, a) {
    ...
    },saveConcept: function(h, c, i, k, d) {
    	//console.log('!!!!zasca.....>saveConcept<');
    },save: function(h, c, i, k, d, saveConcept) {
    	//console.log('zasca.....>' + saveConcept + '<');
        ...
        try {
            this.saveMapXml(j, a, l, i, k, d, saveConcept)
        } catch (b) {
            console.log(b);
            k.onError(this._buildError())
        }
    },load: function(a, idUser) {
        $assert(a, "mapId can not be null");
        var b = this.loadMapDom(a, idUser);
...
mindplot.RESTPersistenceManager = new Class({Extends: mindplot.PersistenceManager,initialize: function(a) {
        this.parent();
        ...
        this.idUserConcept = a.idUserConcept;
    },saveMapXml: function(g, a, i, f, h, d, saveConcept) {
    	//console.log('saveConcept -> ' + saveConcept)
    	var svgXml = window.document.getElementById('workspaceContainer').innerHTML;
    	var myTitle = $('#mindmapTitle').text();
        var b = {id: g, xml: a, properties: i, mySvg: svgXml, title: myTitle};
        var e = this;
        var c = "minor=" + !f;
        c = c + "&timestamp=" + this.timestamp;
        c = c + "&session=" + this.session;
        c = c + "&saveConcept=" + saveConcept;
        c = c + "&idUserConcept=" + this.idUserConcept;
        //c = c + "&mySvg=" + window.btoa(svgXml);
        if (!e.onSave) {
            e.onSave = true;
            ...
            $.ajax({url: this.documentUrl.replace("{id}", g) + "?" + c,type: "put",dataType: "json",data: JSON.stringify(b),contentType: "application/json; charset=utf-8",async: !d,success: function(k, l, j) {
                    e.timestamp = k;
                    h.onSuccess()
                    ...
                    if (o != null && o.indexOf("application/json") != -1) {
                        ...
                        if (this.status == 405) {
                            j = {severity: "SEVERE",message: $msg("SESSION_EXPIRED")}
                        }
                    }
                    h.onError(j);
                    e.onSave = false
        ...
        $.ajax({url: this.revertUrl.replace("{id}", a),async: false,method: "post",headers: {"Content-Type": "application/json; charset=utf-8",Accept: "application/json"}})
    },unlockMap: function(a) {
        var b = a.getId();
    ...
    },loadMapDom: function(b, userId) {
        var a;
        $.ajax({url: this.documentUrlConcept.replace("{id}", b).replace("{userId}", userId) + "/xml",method: "get",async: false,headers: {"Content-Type": "text/plain",Accept: "application/xml"},success: function(c) {
                a = c
            }});
        if (a == null) {
...
mindplot.LocalStorageManager = new Class({Extends: mindplot.PersistenceManager,initialize: function(a, b) {
        this.parent();
        this.documentUrl = a;
        this.forceLoad = b
        ...
        if (a == null || this.forceLoad) {
            $.ajax({url: this.documentUrl.replace("{id}", b),headers: {"Content-Type": "text/plain",Accept: "application/xml"},type: "get",dataType: "text",async: false,success: function(c) {
                    a = c
                }});
            if (a == null) {
                throw new Error("Map could not be loaded")
...
mindplot.EditorProperties = new Class({initialize: function() {
        this._zoom = 0;
        this._position = 0
    },setZoom: function(a) {
        this._zoom = a
...
mindplot.IconGroup = new Class({initialize: function(b, a) {
        ...
        this._iconSize = {width: b,height: a};
...
mindplot.IconGroup.RemoveTip = new Class({initialize: function(a) {
        ...
        var b = new web2d.Group({width: 10,height: 10,x: 0,y: 0,coordSizeWidth: 10,coordSizeHeight: 10});
...
mindplot.Icon = new Class({initialize: function(a) {
        $assert(a, "topic can not be null");
...
mindplot.LinkIcon = new Class({Extends: mindplot.Icon,initialize: function(b, a, c) {
...
mindplot.NoteIcon = new Class({Extends: mindplot.Icon,initialize: function(a, c, b) {
        $assert(a, "topic can not be null");
        ...
        this._tip = new mindplot.widget.FloatingTip($(a.getImage()._peer._native), {title: $msg("NOTE"),container: "body",content: function() {
        ...
        if ($("body").find("#textPopoverNote").length == 1) {
            ...
            var a = $('<div id="textPopoverNote"></div>').css({padding: "5px"});
...
mindplot.ActionIcon = new Class({Extends: mindplot.Icon,initialize: function(b, a) {
        this.parent(a);
        this._node = b
    },getNode: function() {
        return this._node
...
mindplot.ImageIcon = new Class({Extends: mindplot.Icon,initialize: function(b, d, g) {
...
mindplot.model.IconModel = new Class({Extends: mindplot.model.FeatureModel,initialize: function(a) {
...
mindplot.model.LinkModel = new Class({Extends: mindplot.model.FeatureModel,initialize: function(a) {
...
mindplot.model.NoteModel = new Class({Extends: mindplot.model.FeatureModel,initialize: function(b) {
...
mindplot.Command = new Class({initialize: function() {
...
mindplot.DesignerActionRunner = new Class({initialize: function(a, b) {
        $assert(a, "commandContext can not be null");
...
mindplot.DesignerUndoManager = new Class({initialize: function(a) {
        this._undoQueue = [];
        this._redoQueue = [];
        this._baseId = 0
    },enqueue: function(c) {
...
mindplot.ControlPoint = new Class({initialize: function() {
        var b = new web2d.Elipse({width: 6,height: 6,stroke: "1 solid #6589de",fillColor: "gray",visibility: false});
        b.setCursor("pointer");
...
mindplot.EditorOptions = {LayoutManager: "OriginalLayout",textEditor: "TextEditor"};
mindplot.RelationshipPivot = new Class({initialize: function(a, b) {
        $assert(a, "workspace can not be null");
...
mindplot.commands.GenericFunctionCommand = new Class({Extends: mindplot.Command,initialize: function(c, a, b) {
...
mindplot.commands.DeleteCommand = new Class({Extends: mindplot.Command,initialize: function(b, a) {
...
mindplot.commands.DragTopicCommand = new Class({Extends: mindplot.Command,initialize: function(d, b, a, c) {
...
mindplot.commands.AddTopicCommand = new Class({Extends: mindplot.Command,initialize: function(b, a) {
...
mindplot.commands.ChangeFeatureToTopicCommand = new Class({Extends: mindplot.Command,initialize: function(b, c, a) {
        $assert($defined(b), "topicId can not be null");
...
mindplot.commands.RemoveFeatureFromTopicCommand = new Class({Extends: mindplot.Command,initialize: function(a, b) {
...
mindplot.commands.AddFeatureToTopicCommand = new Class({Extends: mindplot.Command,initialize: function(c, b, a) {
...
mindplot.commands.AddRelationshipCommand = new Class({Extends: mindplot.Command,initialize: function(a) {
...
mindplot.commands.MoveControlPointCommand = new Class({Extends: mindplot.Command,initialize: function(b, a) {
...
mindplot.widget.ModalDialogNotifier = new Class({initialize: function() {
    },show: function(c, e) {
...
mindplot.widget.ToolbarNotifier = new Class({initialize: function() {
...
mindplot.widget.ToolbarItem = new Class({Implements: mindplot.Events,initialize: function(c, b, a) {
...
mindplot.widget.ToolbarPaneItem = new Class({Extends: mindplot.widget.ToolbarItem,initialize: function(c, a) {
        $assert(c, "buttonId can not be null");
        $assert(a, "model can not be null");
        this._model = a;
        var d = this;
        ...
        var c = this;
        this._tip = new mindplot.widget.FloatingTip(b, {html: true,placement: "bottom",content: function() {
...
mindplot.widget.NoteEditor = new Class({Extends: BootstrapDialog,initialize: function(b) {
        $assert(b, "model can not be null");
        this._model = b;
...
mindplot.widget.NameEditor = new Class({Extends: BootstrapDialog,initialize: function(b) {
    $assert(b, "model can not be null");
    this._model = b;
    this.parent($msg("NEW_NAME"), {cancelButton: true, closeButton: true, acceptButton: true, onEventData: {model: this._model}});
    this.css({margin: "150px auto"});
    var a = this._buildPanel(b);
    this.setContent(a)
},_buildPanel: function(b) {
    var a = $("<div></div>").css("padding-top", "5px");
    var c = $("<form></form>").attr({action: "none",id: "noteFormId"});
    var d = $("<input></input autofocus>").attr({placeholder: $msg("WRITE_YOUR_TEXT_HERE"),required: "true","class": "form-control"});
    //d.css({width: "100%",height: 80,resize: "none"});
    d.on("keypress", function(e) {
        e.stopPropagation()
    });
...
mindplot.widget.LinkEditor = new Class({Extends: BootstrapDialog,initialize: function(b) {
        $assert(b, "model can not be null");
        this._model = b;
...
mindplot.widget.FloatingTip = new Class({Implements: [Options, mindplot.Events],options: {animation: true,html: false,placement: "right",selector: false,trigger: "hover",title: "",content: "",delay: 0,container: false,destroyOnExit: false},initialize: function(b, a) {
        this.setOptions(a);
        this.element = b;
        this._createPopover()
...
mindplot.widget.LinkIconTooltip = new Class({Extends: mindplot.widget.FloatingTip,initialize: function(a) {
        ...
        var a = $("<div></div>").css({padding: "5px",width: "100%"});
...
mindplot.widget.KeyboardShortcutTooltip = new Class({Extends: mindplot.widget.FloatingTip,initialize: function(a, d) {
...
mindplot.widget.ColorPalettePanel = new Class({Extends: mindplot.widget.ToolbarPaneItem,initialize: function(b, a, c) {
        this._baseUrl = c;
        this.parent(b, a);
        $assert($defined(c), "baseUrl can not be null")
    },_load: function() {
        if (!mindplot.widget.ColorPalettePanel._panelContent) {
            $("<link>").appendTo($("head")).attr({type: "text/css",rel: "stylesheet"}).attr("href", this._baseUrl + "/colorPalette.css");
            var a;
            $.ajax({url: this._baseUrl + "/colorPalette.html",method: "get",async: false,success: function(b) {
                    a = b
                },error: function() {
...
mindplot.widget.ListToolbarPanel = new Class({Extends: mindplot.widget.ToolbarPaneItem,initialize: function(b, a) {
        this.parent(b, a);
        this._initPanel()
    },_initPanel: function() {
        var a = this;
...
mindplot.widget.FontFamilyPanel = new Class({Extends: mindplot.widget.ListToolbarPanel,initialize: function(b, a) {
        this.parent(b, a)
    },buildPanel: function() {
...
mindplot.widget.FontSizePanel = new Class({Extends: mindplot.widget.ListToolbarPanel,initialize: function(b, a) {
        this.parent(b, a)
    },buildPanel: function() {
...
mindplot.widget.TopicShapePanel = new Class({Extends: mindplot.widget.ListToolbarPanel,initialize: function(b, a) {
        this.parent(b, a)
    },buildPanel: function() {
...
mindplot.widget.IconPanel = new Class({Extends: mindplot.widget.ToolbarPaneItem,initialize: function(b, a) {
        this.parent(b, a)
    },_updateSelectedItem: function() {
        return this.getPanelElem()
    },buildPanel: function() {
        var g = $('<div class="toolbarPanel" id="IconsPanel"></div>').css({width: 245,height: 230});
...
mindplot.widget.IMenu = new Class({initialize: function(c, a, b) {
        ...
        var c = mindplot.PersistenceManager.getInstance();
        c.unlockMap(a)
    },saveConcept: function(h, b, f, c) {
    	//console.log('01 - SAVECONCEPT')
        var a = b.getMindmap();
        ...
        d.save(a, e, f, {onSuccess: function() {
                if (f) {
...
mindplot.widget.Menu = new Class({Extends: mindplot.widget.IMenu,initialize: function(H, v, j, A, d) {
        this.parent(H, v, j);
        d = !$defined(d) ? "" : d;
        var c = d + "css/widget";
        ...
        this._addButton("export", false, false, function() {
            BootstrapDialog.Request.active = new BootstrapDialog.Request("c/maps/" + j + "/exportf", $msg("EXPORT"), {cancelButton: true,closeButton: true})
        });
        ...
        this._registerTooltip("saveConcept", $msg("SAVE_CONCEPT"));
        this._addButton("saveConcept", false, false, function() {
            F.saveConcept(r, H, true)
        });
        
        this._registerTooltip("editName", $msg("EDIT_NAME"));        
        this._addButton("editName", false, false, function() {
        	H.editName()
        });
        ...
        if (E) {
            this._addButton("shareIt", false, false, function() {
                BootstrapDialog.Request.active = new BootstrapDialog.Request("c/maps/" + j + "/sharef", $msg("COLLABORATE"), {closeButton: true,cancelButton: true});
        ...
        if (a) {
            this._addButton("publishIt", false, false, function() {
                BootstrapDialog.Request.active = new BootstrapDialog.Request("c/maps/" + j + "/publishf", $msg("PUBLISH"), {closeButton: true,cancelButton: true});
                H.onObjectFocusEvent()
            });
        ...
        if (y) {
            this._addButton("history", false, false, function() {
                BootstrapDialog.Request.active = new BootstrapDialog.Request("c/maps/" + j + "/historyf", $msg("HISTORY"), {closeButton: true,cancelButton: true});
                H.onObjectFocusEvent()
            });
        ...
        if (i) {
            i.bind("click", function(J) {
                BootstrapDialog.Request.active = new BootstrapDialog.Request("c/keyboard", $msg("SHORTCUTS"), {closeButton: true,cancelButton: true});
                H.onObjectFocusEvent();
                J.preventDefault()
            })
        }
...
mindplot.layout.EventBusDispatcher = new Class({initialize: function() {
        ...
        if (a.getId() != 0) {
            this._layoutManager.addNode(a.getId(), {width: 10,height: 10}, a.getPosition());
            this._layoutManager.updateShrinkState(a.getId(), a.areChildrenShrunken())
        }
...
mindplot.layout.ChangeEvent = new Class({initialize: function(a) {
...
mindplot.layout.LayoutManager = new Class({Extends: mindplot.Events,initialize: function(d, b) {
...
mindplot.layout.Node = new Class({initialize: function(d, b, a, c) {
        ...
        if (!c) {
            c = {hasChanged: false,value: null,oldValue: null}
        }
...
mindplot.layout.RootedTreeSet = new Class({initialize: function() {
        this._rootNodes = []
    },setRoot: function(a) {
...
mindplot.layout.ChildrenSorterStrategy = new Class({initialize: function() {
...
mindplot.layout.AbstractBasicSorter = new Class({Extends: mindplot.layout.ChildrenSorterStrategy,computeChildrenIdByHeights: function(c, b) {
        var a = {};
...
mindplot.layout.BalancedSorter = new Class({Extends: mindplot.layout.AbstractBasicSorter,initialize: function() {
        ...
        if (d.length == 0) {
            return [o, {x: h.getPosition().x + r * (h.getSize().width / 2 + mindplot.layout.BalancedSorter.INTERNODE_HORIZONTAL_PADDING * 2),y: h.getPosition().y}]
        }
        var j = null;
        var g = d.getLast();
        ...
        var k = b.map(function(i) {
            return {id: i.getId(),order: i.getOrder(),width: i.getSize().width,height: this._computeChildrenHeight(j, i)}
        }, this).reverse();
        var e = 0;
        var a = 0;
        _.each(k, function(i) {
...
mindplot.layout.SymmetricSorter = new Class({Extends: mindplot.layout.AbstractBasicSorter,initialize: function() {
        ...
        if (x.length == 0) {
            var w = {x: g.getPosition().x + h * (g.getSize().width + mindplot.layout.SymmetricSorter.INTERNODE_HORIZONTAL_PADDING),y: g.getPosition().y};
            return [0, w]
        } else {
            var j = null;
            var f = x.getLast();
        ...
        var j = b.map(function(i) {
            return {id: i.getId(),order: i.getOrder(),position: i.getPosition(),width: i.getSize().width,height: this._computeChildrenHeight(g, i)}
        }, this).reverse();
        var h = 0;
        _.each(j, function(i) {
            h += i.height
...
mindplot.layout.GridSorter = new Class({Extends: mindplot.layout.AbstractBasicSorter,computeOffsets: function(k, c) {
        ...
        var m = b.map(function(i) {
            return {id: i.getId(),height: n._computeChildrenHeight(k, i)}
        });
        var p = {};
        for (var g = 0; 
        g < m.length; 
...
mindplot.layout.OriginalLayout = new Class({initialize: function(a) {
        this._treeSet = a
...
mindplot.EventBus = new Class({Implements: mindplot.Events,initialize: function() {
    }});
