...
CREATE TABLE USER (
	...
	authentication_type CHAR(1) 		CHARACTER SET utf8 NOT NULL,
	authenticator_uri	VARCHAR(255)	CHARACTER SET utf8,
...
CREATE TABLE MINDMAP (
	...
	id_user_concept	INTEGER,  
	id_project_concept	INTEGER,	
...
CREATE TABLE LABEL (
	...
	FOREIGN KEY (parent_label_id) REFERENCES LABEL (id) ON DELETE CASCADE ON UPDATE NO ACTION
) CHARACTER SET utf8;
