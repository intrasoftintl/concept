 ...
 */
@Entity
@Table(name = "MBDecisionCard")
public class MBDecisionCard implements Serializable {
    ...
    public MBDecisionCard(UserCo uid, Moodboard mbId, String title, String keywords, String team, String decision) {
        this.uid = uid;
        this.mbId = mbId;
