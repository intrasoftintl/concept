 ...
 */
@Entity
@Table(name = "BADecisionCard")
public class BADecisionCard implements Serializable {
    ...
    public BADecisionCard(UserCo uid, BriefAnalysis baId, String title, String keywords, String team, String decision) {
        this.uid = uid;
        this.baId = baId;
