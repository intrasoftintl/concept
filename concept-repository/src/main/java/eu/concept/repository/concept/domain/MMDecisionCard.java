 ...
 */
@Entity
@Table(name = "MMDecisionCard")
public class MMDecisionCard implements Serializable {
    ...
    public MMDecisionCard(UserCo uid, MindMap mmId, String title, String keywords, String team, String decision) {
        this.uid = uid;
        this.mmId = mmId;
